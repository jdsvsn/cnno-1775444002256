...
const basePath = '/cnno-1775444002256';
...
export default function Home() {
  ...
  const products = [{ n: 'Cinnamon Swirls', d: 'Indulge in our signature cinnamon swirls, freshly baked with high-quality ingredients and a touch of love, perfect for satisfying your sweet tooth. Each bite is a delight of soft, fluffy dough and sweet, sticky cinnamon.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Delights', d: 'Experience the unique flavor of our pistachio rolls, carefully crafted with ground pistachios and a hint of sweetness, making them a must-try for nut lovers. The combination of crunchy pistachios and soft dough is a match made in heaven.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Dream', d: 'Treat yourself to our rich, chocolatey rolls, made with the finest cocoa and a touch of magic, guaranteed to satisfy any chocolate craving. Each bite is a decadent experience of velvety chocolate and soft, fluffy dough.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80', icon: 'chair' }, { n: 'Baby Bites', d: 'Enjoy our bite-sized baby rolls, perfect for snacking on the go, and made with the same love and care as our larger rolls. These adorable treats are ideal for parties, events, or just a quick pick-me-up.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'eco' }, { n: 'Party Pack', d: 'Get the best deal for your parties and gatherings with our party pack, featuring a selection of our signature rolls, including cinnamon swirls, pistachio delights, and chocolate dreams. This pack is perfect for sharing with friends and family.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft artisanal sweet rolls that bring people together and exceed customer expectations through quality, creativity, and community.</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
